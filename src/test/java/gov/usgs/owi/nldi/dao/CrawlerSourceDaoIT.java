...
public class CrawlerSourceDaoIT extends BaseIT {
  ...
  @Autowired CrawlerSourceDao crawlerSourceDao;
  ...
  public static final String TEST_SOURCE_URI_POINT =
      "http://cida-eros-wqpdev.er.usgs.gov:8080/wqp/Station/search?mimeType=geojson";
  ...
  public static final String TEST_TABLE_NAME_POINT =
      CrawlerSource.FEATURE_TABLE_PREFIX + TEST_SOURCE_SUFFIX_POINT.toLowerCase();
  public static final String TEST_TEMP_TABLE_NAME_POINT =
      TEST_TABLE_NAME_POINT + CrawlerSource.FEATURE_TABLE_TEMP_SUFFIX;
  public static final String TEST_OLD_TABLE_NAME_POINT =
      TEST_TABLE_NAME_POINT + CrawlerSource.FEATURE_TABLE_OLD_SUFFIX;
  ...
  public static final String TEST_TABLE_NAME_TOP_LEVEL =
      CrawlerSource.FEATURE_TABLE_PREFIX + TEST_SOURCE_SUFFIX_TOP_LEVEL.toLowerCase();
  public static final String TEST_TEMP_TABLE_NAME_TOP_LEVEL =
      TEST_TABLE_NAME_TOP_LEVEL + CrawlerSource.FEATURE_TABLE_TEMP_SUFFIX;
  public static final String TEST_OLD_TABLE_NAME_TOP_LEVEL =
      TEST_TABLE_NAME_TOP_LEVEL + CrawlerSource.FEATURE_TABLE_OLD_SUFFIX;
  ...
  public static final String TEST_SOURCE_URI_REACH =
      "https://www.sciencebase.gov/catalogMaps/mapping/ows/54eb4968e4b02d776a67d8ce?service=WFS&version=1.0.0&request=GetFeature&typeName=sb:nwis_gage_events&outputFormat=json";
  ...
  public static final String TEST_TABLE_NAME_REACH =
      CrawlerSource.FEATURE_TABLE_PREFIX + TEST_SOURCE_SUFFIX_REACH.toLowerCase();
  public static final String TEST_TEMP_TABLE_NAME_REACH =
      TEST_TABLE_NAME_REACH + CrawlerSource.FEATURE_TABLE_TEMP_SUFFIX;
  public static final String TEST_OLD_TABLE_NAME_REACH =
      TEST_TABLE_NAME_REACH + CrawlerSource.FEATURE_TABLE_OLD_SUFFIX;
